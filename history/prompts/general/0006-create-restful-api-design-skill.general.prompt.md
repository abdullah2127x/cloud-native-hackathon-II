...
- Complete resource naming conventions (plural nouns) with examples
- HTTP method usage patterns (GET, POST, PUT, PATCH, DELETE) with proper usage
- Status code meanings and appropriate usage (200, 201, 400, 401, 404, 500, etc.)
