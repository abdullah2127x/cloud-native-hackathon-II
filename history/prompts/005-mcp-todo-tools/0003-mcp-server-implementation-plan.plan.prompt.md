...
links:
  ...
  pr: null
files:
  - path: specs/005-mcp-todo-tools/plan.md
    action: created
  - path: specs/005-mcp-todo-tools/research.md
    action: created
  - path: specs/005-mcp-todo-tools/data-model.md
    action: created
  - path: specs/005-mcp-todo-tools/quickstart.md
    action: created
  - path: specs/005-mcp-todo-tools/contracts/add_task.json
    action: created
  - path: specs/005-mcp-todo-tools/contracts/list_tasks.json
    action: created
  - path: specs/005-mcp-todo-tools/contracts/complete_task.json
    action: created
  - path: specs/005-mcp-todo-tools/contracts/delete_task.json
    action: created
  - path: specs/005-mcp-todo-tools/contracts/update_task.json
    action: created
  - path: CLAUDE.md
    action: updated
tests: []
