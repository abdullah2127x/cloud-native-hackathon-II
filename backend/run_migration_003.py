"""
Run database migration for 001-chat-interface.

This script executes the SQL migration to add conversation and message tables.
Task ID: T007
"""
...
def run_migration():
    """Execute the 003 migration SQL"""
    migration_file = "migrations/003_add_conversation_message_tables.sql"
